...
export class ExpenseReportComponent implements OnInit {
  ...
  displayedColumns: string[] = ['titre', 'datesoumission','motifnotefrais', 'statut','commentaire','dateapprobationrejet', 'montanttotal','users', 'action'];
